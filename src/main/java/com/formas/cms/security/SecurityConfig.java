  ...
  SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    return http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(HttpMethod.POST, "/api/contact-submissions", "/api/newsletter-subscriptions", "/api/payments/orders", "/api/payments/wompi/checkout", "/api/payments/wompi/events").permitAll()

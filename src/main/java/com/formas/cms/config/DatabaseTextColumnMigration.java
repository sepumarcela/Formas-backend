...
public class DatabaseTextColumnMigration implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) {
    ...
    List<String> statements = List.of(
        ...
        "alter table if exists product add column if not exists category_id varchar(255)",
        "alter table if exists product add column if not exists name varchar(255)",
        "alter table if exists product add column if not exists price_text text",
        "alter table if exists product add column if not exists net_price numeric(38,2)",
        "alter table if exists product add column if not exists size text",
        "alter table if exists product add column if not exists description text",
        "alter table if exists product add column if not exists material text",
        "alter table if exists product add column if not exists color_finish text",
        "alter table if exists product add column if not exists lead_time text",
        "alter table if exists product add column if not exists technical_sheet text",
        "alter table if exists product add column if not exists discount_percent integer",
        "alter table if exists product add column if not exists discount_label varchar(255)",
        "alter table if exists product add column if not exists discount_start date",
        "alter table if exists product add column if not exists discount_end date",
        "alter table if exists product add column if not exists featured boolean default false",
        "alter table if exists product add column if not exists active boolean default true",
        ...
        "alter table if exists product alter column featured set default false",
        "alter table if exists product alter column active set default true",
        ...
        "update page_content set content_json = replace(content_json, 'sac@formas.com', 'contacto@formasinteriores.com') where page_key = 'contacto' and content_json like '%sac@formas.com%'",
        "update page_content set content_json = replace(content_json, 'sac@formasinteriores.com', 'contacto@formasinteriores.com') where page_key = 'contacto' and content_json like '%sac@formasinteriores.com%'",
        "update page_content set content_json = replace(content_json, 'hola@formasinteriores.com', 'contacto@formasinteriores.com') where page_key = 'contacto' and content_json like '%hola@formasinteriores.com%'",
